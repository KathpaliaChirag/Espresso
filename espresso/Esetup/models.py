...
class AdminHOD(models.Model):
    ...
    admin= models.OneToOneField(CustomUser, on_delete= models.CASCADE) #one to one model between user and hod and same again one to onr for student/staff with user
